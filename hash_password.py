...
def set_page_background(image_url):
    """
    Injects custom CSS to set a full-page, transparent background image
    using a URL.
    """
    css = f"""
    <style>
    /* NEW: Force the main body to be transparent. 
      This is to override Streamlit's dark theme solid background.
    */
    body {{
        background-color: transparent !important;
    }}

    /* This is the pseudo-element that holds the background image */
    body::before {{
        content: "";
        ...
        background-size: contain; /* 'contain' fits the whole image */
        background-position: center center; /* Center the image */
        background-repeat: no-repeat;
        
        /* CHANGED: Opacity increased to 30% (0.3) to be visible on dark mode.
          You can change this value (e.g., 0.2, 0.4, 0.5) as needed.
        */
        opacity: 0.3; 
    ...
    /* These rules make the main Streamlit components transparent */
...
# --- Function Call for Background ---
# This is the correct "raw" link to your image on GitHub
YOUR_IMAGE_URL_HERE = "https://raw.githubusercontent.com/Karthic-S-S/gitdemo/006a10f350438745d3280e9b67c1a97a2e981a0e/image_328558.png.png"
set_page_background(YOUR_IMAGE_URL_HERE)
...
# --- UI Functions ---
def show_login_page():
    """Displays the login form centered with a full-page Tamil Nadu logo background."""
    ...
    st.markdown(
        ...
        <style>
        .stApp {
            background-image: url("file:///mnt/data/f1328dce-1b29-4f17-ba8c-7300c890ee06.png");
        ...
        /* Add a dark translucent overlay for contrast */
        .overlay {
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
            background: rgba(0, 0, 0, 0.45);  /* Adjust opacity for brightness */
            z-index: 0;
        }
    ...
    # ✅ Title in one line
    st.markdown("<div class='app-title'>INVESTIGATION AND EVIDENCE MANAGEMENT</div>", unsafe_allow_html=True)
